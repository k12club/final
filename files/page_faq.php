...
$faq_page = $db->get_row("SELECT setting_value FROM settings WHERE setting_name = 'faq_page' ");
$faq = json_decode($faq_page->setting_value,JSON_UNESCAPED_UNICODE);	 ?>
<!doctype html>
<html class="no-js" lang="en">
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title><?php echo $faq[$system_language][m_title]; ?></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="description" content="<?php echo $faq[$system_language][m_desc]; ?>">
	<meta name="keywords" content="<?php echo $faq[$system_language][m_key]; ?>" />
				...
				<div class="row">
					<div class="cX-adcontent">
						<ul class="cX-pagesequence">
							...
							<li><?php echo $system_xml->footer_1->text; ?></li>
						</ul>
					</div>	
					<div class="col-xs-12 col-sm-7 col-md-8 col-lg-9 pull-right">
						<div id="cX-content" class="cX-content">
							<div class="cX-faqarea">
								<div class="cX-verticalscrollbar cX-dashboardscrollbar">
									<div id="cX-themecollapse" class="cX-themecollapse cX-themecollapsefaq">
										<?php echo base64_decode($faq[$system_language][desc]); ?>
									</div>
								</div>
							</div>
						</div>
