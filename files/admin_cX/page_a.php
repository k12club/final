			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-stack position-left"></i> Page Add
					</div>
					<ul class="breadcrumb">
					...
					<div class="col-md-12 col-sm-12" id="sag_bolum">
														...
														<div class="col-md-6 col-sm-6">
															<div class="panel-body no-padding-bottom">
																<div class="form-group">
																	...
																	<div class="col-lg-8">
																		<input placeholder="Page Name - <?=$d_f->lang_name?>" name="p_name[<?=$d_f->lang_flag?>]" type="text" class="form-control" value="<?=@$faq[$d_f->lang_flag][m_title]?>">
																	</div>
																</div>
																<div class="form-group">
							...
							<?php 
								if(isset($_POST['gd'])){
									...
									$db->query("INSERT INTO pages (p_name, content) VALUES ('$p_n_son','$c_son')");
