...
$faq = json_decode($faq_page->setting_value,JSON_UNESCAPED_UNICODE);	?><!doctype html>
<html lang="tr">
<head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-stack position-left"></i> Faq Page
					</div>
					<ul class="breadcrumb">
					...
					<div class="col-md-12 col-sm-12" id="sag_bolum">
											...
											<div class="tab-content">
												...
												<div class="tab-pane<?php if($d_f->lang_order == 1){ ?> active<?php } ?>" id="faqpage_tab_<?=$d_f->lang_order?>">
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<textarea class="ckeditor" name="editor[<?=$d_f->lang_flag?>]" id="editor-readonly" rows="4" cols="4"><?=@base64_decode($faq[$d_f->lang_flag][desc])?></textarea>
														</div>
													</div>
												</div>
												<?php } ?>
							...
							<?php 
								if(isset($_POST['gd'])){
									...
									$db->query("UPDATE settings SET  setting_value='$c_son' WHERE setting_name = 'faq_page'");
									header("Location: ?m=1");
								}
							 ?>	
