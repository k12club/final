			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-loop position-left"></i> Exchange Add
					</div>
					<ul class="breadcrumb">
						<li><a href="index.c">Dashboards</a></li>
						<li>Exchange</li>						
						<li class="active">Exchange Add</li>
					</ul>	
					<div class="elements">
									...
									<tr>
										...
										<td class="text-center">
											<ul class="icons-list">
												...
												<li><a href="delete.c?q=exchange2&id=<?=$d_f->id?>" data-popup="tooltip" title="Delete" data-placement="bottom"><i class="icon-cross2"></i></a></li>
											</ul>
										</td>
									</tr>	
					...
					<!--sağ kolon başlangıç-->
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h4 class="panel-title"><strong>Exchange Site</strong> / Add</h4>							
							</div>
							<div class="panel-body">
								...
								<div class="form-group">
										...
										<div class="col-lg-8">
											<input name="aff1" type="text" class="form-control">
										</div>
									</div>									
								...
								<div class="form-group">
										...
										<div class="col-lg-8">
											<input name="aff2" type="text" class="form-control">
										</div>
									</div>									
								...
								<div class="panel-body">										
									...
									<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
										<span class="text-semibold">Successfully Added</span>
									</div>
									<?php } ?>
								</div>
								...
								<?php 
									if(isset($_POST['gd'])){
										...
										$db->query("INSERT INTO exchange (e_name, e_desc, e_link) VALUES ('$coin_aff1','$coin_aff2','$coin_aff3')");
										header("Location: ?m=1");
									}
								 ?>	
